...
#### Interfaz gráfica **(3 pts)**

* **(0.3 pts)** Item 1: Pantalla de inicio del juego
* **(0.7 pts)** Item 2: Pausa y reinicio del juego
* **(0.2 pts)** Item 3: Se utilizan parámetros que favorecen el desarrollo del juego
...
| 3 | 0.2 | - |
| 4 | 0.3 | - |
| 5 | 0 | No aparece la cantidad de balas que le quedan al jugador. |
| 6 | 0.5 | - |
| 7 | 0.5 | - |
| 8 | 0.2 | - |
...
* **(0.3 pts)** Item 2: Ataque (Se dispara al hacer click en la dirección del mouse)
...
* **(0.3 pts)** Item 3: Aparición de los zombies
